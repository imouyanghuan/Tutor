 ...
 *         2015-12-9
 */
public class MyStudentsActivity extends BaseActivity implements OnRefreshListener2<ListView> {
	...
	protected void onCreate(Bundle arg0) {
		super.onCreate(arg0);
		setContentView(R.layout.fragment_teacher_mystudent);
		initView();
	}
	...
	protected void initView() {
		...
		adapter = new MatchStudentAdapter(MyStudentsActivity.this, users);
	...
	public void onPullDownToRefresh(PullToRefreshBase<ListView> refreshView) {
		String label = DateUtils.formatDateTime(MyStudentsActivity.this, System.currentTimeMillis(), DateUtils.FORMAT_SHOW_TIME | DateUtils.FORMAT_SHOW_DATE | DateUtils.FORMAT_ABBREV_ALL);
	...
	private void getStudentList(final int pageIndex, final int pageSize) {
		if (!HttpHelper.isNetworkConnected(MyStudentsActivity.this)) {
		...
		HttpHelper.getHelper().get(ApiUrl.MYSTUDENTLIST, TutorApplication.getHeaders(), params, new ObjectHttpResponseHandler<UserListResult>(UserListResult.class) {
