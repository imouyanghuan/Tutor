...
public class AccountDao extends AbstractDao<Account, String> {
	...
	public static class Properties {
		...
		public final static Property FacebookId = new Property(6, String.class, "facebookId", false, "FACEBOOK_ID");
		public final static Property ImAccount = new Property(7, String.class, "imAccount", false, "IM_ACCOUNT");
		public final static Property ImPswd = new Property(8, String.class, "imPswd", false, "IM_PSWD");
	...
	public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
		...
		db.execSQL("CREATE TABLE " + constraint + "\"ACCOUNT\" (" + //
				...
				"\"EMAIL\" TEXT," + // 4: email
				"\"PSWD\" TEXT," + // 5: pswd
				"\"FACEBOOK_ID\" TEXT," + // 6: facebookId
				"\"IM_ACCOUNT\" TEXT," + // 7: imAccount
				"\"IM_PSWD\" TEXT," + // 8: imPswd
				"\"TOKEN\" TEXT," + // 9: token
	...
	protected void bindValues(SQLiteStatement stmt, Account entity) {
		...
		if (facebookId != null) {
			stmt.bindString(7, facebookId);
		}
		String imAccount = entity.getImAccount();
		if (imAccount != null) {
			stmt.bindString(8, imAccount);
		}
		String imPswd = entity.getImPswd();
		if (imPswd != null) {
			stmt.bindString(9, imPswd);
		}
	...
	public Account readEntity(Cursor cursor, int offset) {
		Account entity = new Account( //
				...
				cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // facebookId
				cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // imAccount
				cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8), // imPswd
	...
	public void readEntity(Cursor cursor, Account entity, int offset) {
		...
		entity.setFacebookId(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
		entity.setImAccount(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
		entity.setImPswd(cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));
